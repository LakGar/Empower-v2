            ...
            <AnimatePresence mode="wait">
              {step === "form" && (
                <motion.div
                  ...
                  className="p-6 md:p-12 flex-1 overflow-y-auto"
                >
                  <div className="max-w-2xl mx-auto">
                    ...
                    >
                      ...
                      <div className="flex justify-end pt-4 pb-6 md:pb-0 sticky bottom-0 bg-black/95 backdrop-blur-sm -mx-6 md:-mx-12 px-6 md:px-12">
                        <Button
                          type="submit"
                          size="lg"
